...
use url::Url;
use wasmer::{DeserializeError, Function, Imports, Instance, Module, Store, TypedFunction, Value};
...
impl Run2 {
    ...
    fn execute_wasm(
        ...
        } else if wasmer_wasi::is_wasi_module(module) || wasmer_wasi::is_wasix_module(module) {
